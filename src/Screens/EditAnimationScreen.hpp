...
namespace flui
{
	...
	private:
		...
		fgl::BasicDictionary<fl::MetaPointType, LabeledCheckboxElement*> metapointCheckboxElements;
		LabeledCheckboxElement* showBoundsCheckbox;
		fgl::TextElement* anchorSizeLabel;
		NumberAdjustElement* anchorSizeAdjuster;
